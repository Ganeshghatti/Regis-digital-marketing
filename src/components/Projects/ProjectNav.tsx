...
interface Projects {
  ...
  Website: Project[];
  Video: Project[];
  'Social Media': Project[]; // Changed from SocialMedia to 'Social Media'
}

type SectionKey = keyof Projects; // This will now include 'Social Media'
...
const ProjectNav: React.FC = () => {
  ...
  const projects: Projects = {
    ...
    'Social Media': [ // Changed from SocialMedia to 'Social Media'
  ...
  return (
    <div className="p-4 md:p-6">
      <div className="flex flex-col md:flex-row justify-between items-start h-auto mb-4 md:mx-20 border-b border-[#747474] pb-2">
        <div className="flex flex-col">
          <h1 
            className="text-[#26326D] text-[20px] md:text-[24px] font-light leading-[28.8px] tracking-[0.04em] text-left mx-6"
            style={{ fontFamily: 'Luxora Grotesk, sans-serif' }}
          >
            Projects
          </h1>
        </div>
        <div className="flex space-x-2 md:space-x-4 mr-6 md:mr-20 overflow-x-auto whitespace-nowrap">
